<template>
	<view class="back-content">
		<image class="blur" :src="(songInfo.al && songInfo.al.pic==0)?playListDJ[indexDJ].picUrl:(songInfo.al && songInfo.al.picUrl)" mode="widthFix"/>
	  <view class="container" @tap="closeList">
	    <view class="topBar" :style="{'height':(h + 44) + 'px','line-height':(2 * h + 44) + 'px'}">
	      ...
	      <view class="songName">{{songInfo.name || playListSongInfo.name || '暂无数据'}}</view>
	    ...
	    <view class="content-image" :style="{'top':h+50+'px'}">
	      ...
	      <view class="disc-content">
	        ...
	        <view class="song-back">
	          <image class="songback-img" :src="(songInfo.al && songInfo.al.pic==0)?playListDJ[indexDJ].picUrl:(songInfo.al && songInfo.al.picUrl)" mode="widthFix"/>
	        </view>
	      </view>
	    </view>
	    <!-- 歌词展示 -->
			...
			_getUrl(id) {
				getSongUrl(id).then(res => {
					...
					if(musicSrc) {
						...
						app.globalData.backgroundAudioManager.coverImgUrl = (this.songInfo.al && this.songInfo.al.pic==0)?this.playListDJ[this.indexDJ].picUrl:(this.songInfo.al && this.songInfo.al.picUrl)
						app.globalData.backgroundAudioManager.title = this.songInfo.name || this.playListSongInfo.name || '暂无'
